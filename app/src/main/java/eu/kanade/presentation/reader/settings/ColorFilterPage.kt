...
internal fun ColumnScope.ColorFilterPage(screenModel: ReaderSettingsScreenModel) {
    // Brightness
    PreferenceGroupCard(title = stringResource(MR.strings.pref_custom_brightness)) {
    ...
    // Color filter
    PreferenceGroupCard(title = stringResource(MR.strings.pref_custom_color_filter)) {
    ...
    // Effects
    PreferenceGroupCard(title = stringResource(MR.strings.pref_filter_effects)) {
        CheckboxItem(
