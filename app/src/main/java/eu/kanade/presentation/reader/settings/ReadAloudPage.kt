...
internal fun ColumnScope.ReadAloudPage(
    ...
    // Speech: rate + playback progression behavior.
    PreferenceGroupCard(title = stringResource(MR.strings.pref_group_speech)) {
        SliderItem(
    ...
    // Speech cleanup: what the engine says and how it says it.
    PreferenceGroupCard(title = stringResource(MR.strings.pref_tts_speech_cleanup_section)) {
        CheckboxItem(
    ...
    // Spoken content: which OCR region types get spoken.
    PreferenceGroupCard(title = stringResource(MR.strings.pref_tts_spoken_content_section)) {
        CheckboxItem(
    ...
    // OCR & text recognition: exclusions.
    PreferenceGroupCard(title = stringResource(MR.strings.ocr_exclusion_section)) {
        CheckboxItem(
